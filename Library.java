...
class MainFrame extends JFrame implements ActionListener {
    ...
    private JButton searchBook, addNewBook, updateBookInfo, viewBookInfo, searchStudent, viewStudentInfo, updateStudentInfo,
            addStudent, searchBooking, viewAllBookings, newBooking, deleteBooking;
    ...
    class SearchBookText extends JPanel {
        ...
        public SearchBookText() {
            ...
            JButton done = new JButton("Search Book");
    ...
    public void actionPerformed(ActionEvent evt) {
        if (evt.getActionCommand().equals("Search Book")) {
            new SearchBookFrame();
        } else if (evt.getActionCommand().equals("Add New Book")) {
            new AddNewBookFrame();
        } else if (evt.getActionCommand().equals("Update Book Information")) {
            new UpdateBookInformationFrame();
        } else if (evt.getActionCommand().equals("View Book Information")) {
            new ViewBookInformationFrame();
            showMe();
        } else if (evt.getActionCommand().equals("Search Student")) {
            new SearchStudentFrame();
        } else if (evt.getActionCommand().equals("View Student Information")) {
            new ViewStudentInfoFrame();
            viewStudent();
        } else if (evt.getActionCommand().equals("Update Student Information")) {
            new UpdateStudentInformationFrame();
        } else if (evt.getActionCommand().equals("Add New Student")) {
            new AddStudentFrame();
        } else if (evt.getActionCommand().equals("Search Booking")) {
            new SearchBookingFrame();
        } else if (evt.getActionCommand().equals("View All Bookings")) {
            new ViewAllBookings();
            viewAll();
        } else if (evt.getActionCommand().equals("New Booking")) {
            new NewBookingFrame();
        } else if (evt.getActionCommand().equals("Delete Booking")) {
